...
% additional packages (NOTE: include only if needed)
\usepackage{hyperref}
\usepackage{xcolor}
\usepackage{todonotes}
\usepackage[numbers]{natbib} % improved bib management
\usepackage{framed} % to highlight a paragraph (e.g., in results)

% Please refer to the LaTeX showcase (https://github.com/Intelligent-Testing-Lab/latex-showcase) for more packages and examples

% macro
\newcommand{\DS}[1]{\todo[inline,color=blue,textcolor=white]{#1}}
